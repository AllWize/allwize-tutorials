...
Open a new window in the Arduino IDE and copy paste this code. The code has different sections:

* **Dependencies**, where all dependencies are included into the code
* **Configuration**, where we define several constants that will be used in the code
* **Globals**, where we define objects that will be used
* **AllWize**, with the setup and send methods for the radio
* **Sensors**, with the setup and read methods for the different magnitudes
* **Main**, where the loop and setup methods are defined
...
[Previous: Install device dependencies to the Arduino IDE](03-arduino-ide-device-dependencies.md) |
[Tutorial menu](readme.md) |
[Next: Install gateway support to the Arduino IDE](05-arduino-ide-esp8266-support.md)